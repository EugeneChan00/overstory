...
export async function loadConfig(projectRoot: string): Promise<OverstoryConfig> {
	...
	const hasRuntimeSection =
		parsed.runtime !== undefined && parsed.runtime !== null && typeof parsed.runtime === "object";
	...
	// Migration-safe fallback: legacy configs (without runtime block) keep Claude behavior.
	// New configs generated by init include runtime defaults explicitly.
